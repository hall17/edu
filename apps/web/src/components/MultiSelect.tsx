...
interface MultiSelectProps
   ...
   * Optional, defaults to translated "Select options".
   */
  placeholder?: string;
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    const effectivePlaceholder = placeholder || t('multiSelect.selectOptions');
    ...
    const isGroupedOptions = React.useCallback(
      (
        ...
        return Boolean(
          opts && opts.length > 0 && opts[0] && 'heading' in opts[0]
        );
      },
      []
    );
    ...
    React.useEffect(() => {
      ...
      if (selectedCount !== prevSelectedCount.current) {
        ...
        if (diff > 0) {
          ...
          if (addedLabels.length === 1) {
            announce(
              t('multiSelect.optionSelectedSingle', {
            ...
            announce(
              t('multiSelect.optionsSelectedMultiple', {
      ...
      if (isPopoverOpen !== prevIsOpen.current) {
        if (isPopoverOpen) {
          announce(t('multiSelect.dropdownOpened', { total: totalOptions }));
        } else {
          announce(t('multiSelect.dropdownClosed'));
        }
        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              } options selected. ${effectivePlaceholder}`}
              className={cn(
                ...
                <div className="flex w-full items-center justify-between">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              aria-label={t('multiSelect.removeFromSelection', {
                                option: option.label,
                              })}
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      aria-label={t('multiSelect.clearAllSelected', {
                        count: selectedValues.length,
                      })}
          ...
          <PopoverContent
            ...
            aria-label={t('multiSelect.selectOptions')}
            className={cn(
              'w-auto p-0',
          ...
          >
            <Command>
              ...
              >
                <CommandEmpty>
                  {emptyIndicator || t('multiSelect.noResults')}
                </CommandEmpty>{' '}
                {!hideSelectAll && !searchValue && (
                  <CommandGroup>
                    <CommandItem
                      ...
                      aria-label={t('multiSelect.selectAllOptions', {

...
function ClassroomSessionsTableViewContent() {
                            ...
                            <div className="flex-1 space-y-3">
                              ...
                              <div className="space-y-2">
                                {session.teacher && (
                                  <div className="flex items-center gap-2">
                                    <span className="text-muted-foreground text-sm font-medium">
                                      {t('classrooms.sessions.labels.teacher')}:
                                    </span>
                                    <Badge
                                      variant="secondary"
                                      className="text-xs"
                                ...
                                {session.classroomIntegration?.subject && (
                                  <div className="flex items-center gap-2">
                                    <span className="text-muted-foreground text-sm font-medium">
                                      {t('classrooms.sessions.labels.subject')}:
                                    </span>
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-muted-foreground text-sm">
                                      ...
                                      {t('classrooms.sessions.labels.students')}{' '}
...
export function ClassroomSessionsTableView() {
  return (
    <ClassroomSessionsProvider>
      <ClassroomSessionsTableViewContent />
    </ClassroomSessionsProvider>
  );
}

...
interface ClassroomTemplatesDataTableToolbarProps<TData> {
  table: Table<TData>;
}

export function ClassroomTemplatesDataTableToolbar<TData>({
  table,
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2">
        <SearchInput
          placeholder={t('classrooms.templates.table.filterPlaceholder')}
          value={filters.q ?? ''}

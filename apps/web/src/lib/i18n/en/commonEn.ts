...
export const common = {
  ...
  common: {
    ...
    uploadProfilePicture: 'Upload Photo',
    changeProfilePicture: 'Change Photo',
    profilePictureUploadHelp: 'Click or drag image • PNG, JPG, WEBP up to 5MB',
    profilePicturePreview: 'Profile Picture Preview',
    logoUrl: 'Logo',
    uploadLogo: 'Upload Logo',
    changeLogo: 'Change Logo',
    logoUploadHelp: 'Click or drag image • PNG, JPG, WEBP up to 5MB',
